...
We reproduce these results almost exactly:

| Model  | $$n_l$$ | $$n_h$$ | $$d_{m(odel)}$$ | $$n_v$$ | $$n_{params}$$ |
| ------ | ------- | ------- | --------------- | ------- | -------------- |
| Small  | 12      | 12      | 768             | 50257   | 125187840      |
| Medium | 24      | 16      | 1024            | 50257   | 355771392      |
| Large  | 24      | 16      | 1536            | 50257   | 760149504      |
| XL     | 24      | 24      | 2048            | 50257   | 1315522560     |
| 2.7B   | 32      | 32      | 2560            | 50257   | 2651220480     |
| 6.7B   | 32      | 32      | 4096            | 50257   | 6657871872     |
| 13B    | 40      | 40      | 5140            | 50257   | 12952106100    |
| 175B   | 96      | 96      | 12288           | 50257   | 174599516160   |

We could also break down the results by component:

| Model  | n_params | Attn   | FFN    | $$W_{te}$$ | $$W_{pe}$$ |
| ------ | -------- | ------ | ------ | ---------- | ---------- |
